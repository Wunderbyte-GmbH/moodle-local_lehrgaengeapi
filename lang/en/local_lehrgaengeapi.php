...
$string['certificatefile'] = 'Client certificate file';
$string['certificatefiledesc'] = 'Absolute path to the client certificate file for this tenant. Moodle checks whether the file exists.';
$string['certificationpath'] = 'Certification path';
$string['certificationpathdesc'] = 'Absolute path to a directory used for further calculations. Moodle checks whether this path exists and is a directory.';
...
$string['keyfile'] = 'Client key file';
$string['keyfiledesc'] = 'Absolute path to the client key file for this tenant. Moodle checks whether the file exists.';
